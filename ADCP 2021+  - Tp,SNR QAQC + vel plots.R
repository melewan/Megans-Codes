...
for(i in 1:nrow(ADCP2021)) {
  if(ADCP2021$Tp[i] == 256) {
    ADCP2021$Hs[i] = "NA"
    ADCP2021$Aband0[i] = "NA"
    ADCP2021$Aband1[i] = "NA"
    ADCP2021$Aband2[i] = "NA"
    ADCP2021$Aband3[i] = "NA"
    ADCP2021$Aband4[i] = "NA"
    ADCP2021$Aband5[i] = "NA"
    ADCP2021$Aband6[i] = "NA"
    ADCP2021$Aband7[i] = "NA"
    ADCP2021$Aband8[i] = "NA"
    ADCP2021$Aband9[i] = "NA"
    }
}

# Replace values with NA if SNR < 7 counts
#NAfunction = function(snr, vel) {
#  for(i in 1:nrow(ADCP2021)) {
 #               if(snr[i] <= 7) {
 #                 vel[i] = "NA"
 #                  }
 #               }
#}
#NAfunction(ADCP2021$Cell10SNR1, ADCP2021$Cell10Ve)
...
for(i in 1:nrow(ADCP2021)) {
  #Overall
  if(ADCP2021$SNR1[i] <= 7) {
    ADCP2021$VelocityE[i] = "NA"
  }
  if(ADCP2021$SNR2[i] <= 7) {
    ADCP2021$VelocityN[i] = "NA"
  }
  if(ADCP2021$SNR3[i] <= 7) {
    ADCP2021$VelocityU[i] = "NA"
  }
  #Overall Speed adjustment
  if(ADCP2021$SNR1[i] <= 7 || ADCP2021$SNR2[i] <= 7 || ADCP2021$SNR3[i] <= 7) {
    ADCP2021$Speed[i] = "NA"
    ADCP2021$Direction[i] = "NA"
  }
  #Cell01
  if(ADCP2021$Cell01SNR1[i] <= 7) {
    ADCP2021$Cell01Ve[i] = "NA"
  }
  if(ADCP2021$Cell01SNR2[i] <= 7) {
    ADCP2021$Cell01Vn[i] = "NA"
  }
  if(ADCP2021$Cell01SNR3[i] <= 7) {
    ADCP2021$Cell01Vu[i] = "NA"
  }
  if(ADCP2021$Cell01SNR1[i] <= 7 || ADCP2021$Cell01SNR2[i] <= 7 || ADCP2021$Cell01SNR3[i] <= 7) {
    ADCP2021$Cell01Spd[i] = "NA"
    ADCP2021$Cell01Dir[i] = "NA"
  }
  #Cell02
  if(ADCP2021$Cell02SNR1[i] <= 7) {
    ADCP2021$Cell02Ve[i] = "NA"
  }
  if(ADCP2021$Cell02SNR2[i] <= 7) {
    ADCP2021$Cell02Vn[i] = "NA"
  }
  if(ADCP2021$Cell02SNR3[i] <= 7) {
    ADCP2021$Cell02Vu[i] = "NA"
  }
  if(ADCP2021$Cell02SNR1[i] <= 7 || ADCP2021$Cell02SNR2[i] <= 7 || ADCP2021$Cell02SNR3[i] <= 7) {
    ADCP2021$Cell02Spd[i] = "NA"
    ADCP2021$Cell02Dir[i] = "NA"
  }
  #Cell03
  if(ADCP2021$Cell03SNR1[i] <= 7) {
    ADCP2021$Cell03Ve[i] = "NA"
  }
  if(ADCP2021$Cell03SNR2[i] <= 7) {
    ADCP2021$Cell03Vn[i] = "NA"
  }
  if(ADCP2021$Cell03SNR3[i] <= 7) {
    ADCP2021$Cell03Vu[i] = "NA"
  }
  if(ADCP2021$Cell03SNR1[i] <= 7 || ADCP2021$Cell03SNR2[i] <= 7 || ADCP2021$Cell03SNR3[i] <= 7) {
    ADCP2021$Cell03Spd[i] = "NA"
    ADCP2021$Cell03Dir[i] = "NA"
  }
  #Cell04
  if(ADCP2021$Cell04SNR1[i] <= 7) {
    ADCP2021$Cell04Ve[i] = "NA"
  }
  if(ADCP2021$Cell04SNR2[i] <= 7) {
    ADCP2021$Cell04Vn[i] = "NA"
  }
  if(ADCP2021$Cell04SNR3[i] <= 7) {
    ADCP2021$Cell04Vu[i] = "NA"
  }
  if(ADCP2021$Cell04SNR1[i] <= 7 || ADCP2021$Cell04SNR2[i] <= 7 || ADCP2021$Cell04SNR3[i] <= 7) {
    ADCP2021$Cell04Spd[i] = "NA"
    ADCP2021$Cell04Dir[i] = "NA"
  }
  #Cell05
  if(ADCP2021$Cell05SNR1[i] <= 7) {
    ADCP2021$Cell05Ve[i] = "NA"
  }
  if(ADCP2021$Cell05SNR2[i] <= 7) {
    ADCP2021$Cell05Vn[i] = "NA"
  }
  if(ADCP2021$Cell05SNR3[i] <= 7) {
    ADCP2021$Cell05Vu[i] = "NA"
  }
  if(ADCP2021$Cell05SNR1[i] <= 7 || ADCP2021$Cell05SNR2[i] <= 7 || ADCP2021$Cell05SNR3[i] <= 7) {
    ADCP2021$Cell05Spd[i] = "NA"
    ADCP2021$Cell05Dir[i] = "NA"
  }
  #Cell06
  if(ADCP2021$Cell06SNR1[i] <= 7) {
    ADCP2021$Cell06Ve[i] = "NA"
  }
  if(ADCP2021$Cell06SNR2[i] <= 7) {
    ADCP2021$Cell06Vn[i] = "NA"
  }
  if(ADCP2021$Cell06SNR3[i] <= 7) {
    ADCP2021$Cell06Vu[i] = "NA"
  }
  if(ADCP2021$Cell06SNR1[i] <= 7 || ADCP2021$Cell06SNR2[i] <= 7 || ADCP2021$Cell06SNR3[i] <= 7) {
    ADCP2021$Cell06Spd[i] = "NA"
    ADCP2021$Cell06Dir[i] = "NA"
  }
  #Cell07
  if(ADCP2021$Cell07SNR1[i] <= 7) {
    ADCP2021$Cell07Ve[i] = "NA"
  }
  if(ADCP2021$Cell07SNR2[i] <= 7) {
    ADCP2021$Cell07Vn[i] = "NA"
  }
  if(ADCP2021$Cell07SNR3[i] <= 7) {
    ADCP2021$Cell07Vu[i] = "NA"
  }
  if(ADCP2021$Cell07SNR1[i] <= 7 || ADCP2021$Cell07SNR2[i] <= 7 || ADCP2021$Cell07SNR3[i] <= 7) {
    ADCP2021$Cell07Spd[i] = "NA"
    ADCP2021$Cell07Dir[i] = "NA"
  }
  #Cell08
  if(ADCP2021$Cell08SNR1[i] <= 7) {
    ADCP2021$Cell08Ve[i] = "NA"
  }
  if(ADCP2021$Cell08SNR2[i] <= 7) {
    ADCP2021$Cell08Vn[i] = "NA"
  }
  if(ADCP2021$Cell08SNR3[i] <= 7) {
    ADCP2021$Cell08Vu[i] = "NA"
  }
  if(ADCP2021$Cell08SNR1[i] <= 7 || ADCP2021$Cell08SNR2[i] <= 7 || ADCP2021$Cell08SNR3[i] <= 7) {
    ADCP2021$Cell08Spd[i] = "NA"
    ADCP2021$Cell08Dir[i] = "NA"
  }
  #Cell09
  if(ADCP2021$Cell09SNR1[i] <= 7) {
    ADCP2021$Cell09Ve[i] = "NA"
  }
  if(ADCP2021$Cell09SNR2[i] <= 7) {
    ADCP2021$Cell09Vn[i] = "NA"
  }
  if(ADCP2021$Cell09SNR3[i] <= 7) {
    ADCP2021$Cell09Vu[i] = "NA"
  }
  if(ADCP2021$Cell09SNR1[i] <= 7 || ADCP2021$Cell09SNR2[i] <= 7 || ADCP2021$Cell09SNR3[i] <= 7) {
    ADCP2021$Cell09Spd[i] = "NA"
    ADCP2021$Cell09Dir[i] = "NA"
  }
  #Cell10
  if(ADCP2021$Cell10SNR1[i] <= 7) {
    ADCP2021$Cell10Ve[i] = "NA"
  }
  if(ADCP2021$Cell10SNR2[i] <= 7) {
    ADCP2021$Cell10Vn[i] = "NA"
  }
  if(ADCP2021$Cell10SNR3[i] <= 7) {
    ADCP2021$Cell10Vu[i] = "NA"
  }
  if(ADCP2021$Cell10SNR1[i] <= 7 || ADCP2021$Cell10SNR2[i] <= 7 || ADCP2021$Cell10SNR3[i] <= 7) {
    ADCP2021$Cell10Spd[i] = "NA"
    ADCP2021$Cell10Dir[i] = "NA"
  }
}
