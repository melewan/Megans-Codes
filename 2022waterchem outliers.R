...
setwd("F:/DATA/Coastal Ecosystems/Production Dynamics/Cladophora/Data/2022/WaterChem")

# Import WaterChem2020 file
waterchem20 <- read.csv("F:/DATA/Coastal Ecosystems/Production Dynamics/Cladophora/Data/2022/WaterChem/WaterChem2022.xlsx", 
                        header = TRUE)
