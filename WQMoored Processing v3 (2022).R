...
setwd("F:/DATA/Coastal Ecosystems/Production Dynamics/Cladophora/Data/Multi Year QC/QCCodeAndProcessing/WQMoored Processing/2022")
...
# Add columns
all.moored <- add_column(all.moored, Year = 2022, 
                            .before = "DateTime")
...
## Load Cast data 
WaterQualityProfiles2022 <- read.csv("WaterQualityProfiles2022.csv")

# Change date format to match moored data
WaterQualityProfiles2022$Date = as.Date(WaterQualityProfiles2022$Date, 
                                             format = "%m/%d/%Y")

# Change format of Date column to match Time format
WaterQualityProfiles2022$Time = as.character(WaterQualityProfiles2022$Time)

# Concatenate Date and Time columns 
WaterQualityProfiles2022 = add_column(WaterQualityProfiles2022, DateTime = paste
                        (WaterQualityProfiles2022$Date,
                          WaterQualityProfiles2022$Time,
                          sep = " ", collapse = NULL), .before = "Date")

# Change BDLs to 0 and make column numeric
WaterQualityProfiles2022$AveChl [WaterQualityProfiles2022$AveChl == "BDL"]<-0
WaterQualityProfiles2022$AveChl <- as.numeric(WaterQualityProfiles2022$AveChl)
WaterQualityProfiles2022$AveTurb [WaterQualityProfiles2022$AveTurb == "BDL"]<-0
WaterQualityProfiles2022$AveTurb <- as.numeric(WaterQualityProfiles2022$AveTurb)
WaterQualityProfiles2022$AvePhycocyanin [WaterQualityProfiles2022$AvePhycocyanin == "BDL"]<-0
WaterQualityProfiles2022$AvePhycocyanin <- as.numeric(WaterQualityProfiles2022$AvePhycocyanin)


# POSIXct formatting
WaterQualityProfiles2022$DateTime <- as.POSIXct(WaterQualityProfiles2022$DateTime, format = "%Y-%m-%d %H:%M:%S", tz = "UTC")


## Subset all EEP data
EEP = subset(WaterQualityProfiles2022, Transect == "EEP")
...
EEP.bottom = rbind(EEP.May.bottom, EEP.June.bottom, EEP.July.bottom, EEP.August.bottom)
EEP.bottom$AvepH[3] = "NA"
EEP.bottom$AvepH = as.numeric(EEP.bottom$AvepH)


HAL = subset(WaterQualityProfiles2022, Transect == "HAL")

# Subset HAL data by month and station
HAL.May = subset(HAL, Date == "2022-06-02" & Station == "6") # change in 2023
...
setwd(choose.dir(caption = "Select folder to save WQMoored Graphs"))
...
EEP.pH = pH_QAQC(EEP.moored, EEP.depth, EEP.bottom, "EEP 6 m 2022")
HAL.pH = pH_QAQC(HAL.moored, HAL.depth, HAL.bottom, "HAL 6 m 2022")
...
EEP.chl = chl_QAQC(EEP.moored, EEP.depth, EEP.bottom, "EEP 6 m 2022")
HAL.chl = chl_QAQC(HAL.moored, HAL.depth, HAL.bottom, "HAL 6 m 2022")
...
EEP.DO = DO_QAQC(EEP.moored, EEP.depth, EEP.bottom, "EEP 6 m 2022")
HAL.DO = DO_QAQC(HAL.moored, HAL.depth, HAL.bottom, "HAL 6 m 2022")
...
EEP.spc = SpCond_QAQC(EEP.moored, EEP.depth, EEP.bottom, "EEP 6 m 2022")
HAL.spc = SpCond_QAQC(HAL.moored, HAL.depth, HAL.bottom, "HAL 6 m 2022")
...
EEP.turb = Turb_QAQC(EEP.moored, EEP.depth, EEP.bottom, "EEP 6 m 2022")
HAL.turb = Turb_QAQC(HAL.moored, HAL.depth, HAL.bottom, "HAL 6 m 2022")
...
EEP.temp = Temp_QAQC(EEP.moored, EEP.depth, EEP.bottom, "EEP 6 m 2022")
HAL.temp = Temp_QAQC(HAL.moored, HAL.depth, HAL.bottom, "HAL 6 m 2022")
...
EEP.bga = BGA_QAQC(EEP.moored, EEP.depth, EEP.bottom, "EEP 6 m 2022")
HAL.bga = BGA_QAQC(HAL.moored, HAL.depth, HAL.bottom, "HAL 6 m 2022")
