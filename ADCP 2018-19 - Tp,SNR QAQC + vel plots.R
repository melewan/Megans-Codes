...
# designed for specifics of 2018-2019 files #
...
setwd("F:/DATA/Coastal Ecosystems/Production Dynamics/Cladophora/Data/Multi Year QC/QCCodeAndProcessing/ADCP/Data files")
...
for(i in 1:nrow(ADCP2018)) {
  if(ADCP2018$Tp[i] == 256) {
    ADCP2018$Hs[i] = "NA"
    ADCP2018$Aband0[i] = "NA"
    ADCP2018$Aband1[i] = "NA"
    ADCP2018$Aband2[i] = "NA"
    ADCP2018$Aband3[i] = "NA"
    ADCP2018$Aband4[i] = "NA"
    ADCP2018$Aband5[i] = "NA"
    ADCP2018$Aband6[i] = "NA"
    ADCP2018$Aband7[i] = "NA"
    ADCP2018$Aband8[i] = "NA"
    ADCP2018$Aband9[i] = "NA"
    }
}
...
for(i in 1:nrow(ADCP2019)) {
  if(ADCP2019$Tp[i] == 256) {
    ADCP2019$Hs[i] = "NA"
    ADCP2019$Aband0[i] = "NA"
    ADCP2019$Aband1[i] = "NA"
    ADCP2019$Aband2[i] = "NA"
    ADCP2019$Aband3[i] = "NA"
    ADCP2019$Aband4[i] = "NA"
    ADCP2019$Aband5[i] = "NA"
    ADCP2019$Aband6[i] = "NA"
    ADCP2019$Aband7[i] = "NA"
    ADCP2019$Aband8[i] = "NA"
    ADCP2019$Aband9[i] = "NA"
  }
}
...
for(i in 1:nrow(ADCP2018)) {
  #Overall
  if(ADCP2018$SNR1[i] <= 7) {
    ADCP2018$VelocityE[i] = "NA"
  }
  if(ADCP2018$SNR2[i] <= 7) {
    ADCP2018$VelocityN[i] = "NA"
  }
  if(ADCP2018$SNR3[i] <= 7) {
    ADCP2018$VelocityU[i] = "NA"
  }
  #Overall Speed adjustment
  if(ADCP2018$SNR1[i] <= 7 || ADCP2018$SNR2[i] <= 7 || ADCP2018$SNR3[i] <= 7) {
    ADCP2018$Speed[i] = "NA"
    ADCP2018$Direction[i] = "NA"
  }
  #Cell01
  if(ADCP2018$Cell01SNR1[i] <= 7) {
    ADCP2018$Cell01Ve[i] = "NA"
  }
  if(ADCP2018$Cell01SNR2[i] <= 7) {
    ADCP2018$Cell01Vn[i] = "NA"
  }
  if(ADCP2018$Cell01SNR3[i] <= 7) {
    ADCP2018$Cell01Vu[i] = "NA"
  }
  if(ADCP2018$Cell01SNR1[i] <= 7 || ADCP2018$Cell01SNR2[i] <= 7 || ADCP2018$Cell01SNR3[i] <= 7) {
    ADCP2018$Cell01Spd[i] = "NA"
    ADCP2018$Cell01Dir[i] = "NA"
  }
  #Cell02
  if(ADCP2018$Cell02SNR1[i] <= 7) {
    ADCP2018$Cell02Ve[i] = "NA"
  }
  if(ADCP2018$Cell02SNR2[i] <= 7) {
    ADCP2018$Cell02Vn[i] = "NA"
  }
  if(ADCP2018$Cell02SNR3[i] <= 7) {
    ADCP2018$Cell02Vu[i] = "NA"
  }
  if(ADCP2018$Cell02SNR1[i] <= 7 || ADCP2018$Cell02SNR2[i] <= 7 || ADCP2018$Cell02SNR3[i] <= 7) {
    ADCP2018$Cell02Spd[i] = "NA"
    ADCP2018$Cell02Dir[i] = "NA"
  }
  #Cell03
  if(ADCP2018$Cell03SNR1[i] <= 7) {
    ADCP2018$Cell03Ve[i] = "NA"
  }
  if(ADCP2018$Cell03SNR2[i] <= 7) {
    ADCP2018$Cell03Vn[i] = "NA"
  }
  if(ADCP2018$Cell03SNR3[i] <= 7) {
    ADCP2018$Cell03Vu[i] = "NA"
  }
  if(ADCP2018$Cell03SNR1[i] <= 7 || ADCP2018$Cell03SNR2[i] <= 7 || ADCP2018$Cell03SNR3[i] <= 7) {
    ADCP2018$Cell03Spd[i] = "NA"
    ADCP2018$Cell03Dir[i] = "NA"
  }
  #Cell04
  if(ADCP2018$Cell04SNR1[i] <= 7) {
    ADCP2018$Cell04Ve[i] = "NA"
  }
  if(ADCP2018$Cell04SNR2[i] <= 7) {
    ADCP2018$Cell04Vn[i] = "NA"
  }
  if(ADCP2018$Cell04SNR3[i] <= 7) {
    ADCP2018$Cell04Vu[i] = "NA"
  }
  if(ADCP2018$Cell04SNR1[i] <= 7 || ADCP2018$Cell04SNR2[i] <= 7 || ADCP2018$Cell04SNR3[i] <= 7) {
    ADCP2018$Cell04Spd[i] = "NA"
    ADCP2018$Cell04Dir[i] = "NA"
  }
  #Cell05
  if(ADCP2018$Cell05SNR1[i] <= 7) {
    ADCP2018$Cell05Ve[i] = "NA"
  }
  if(ADCP2018$Cell05SNR2[i] <= 7) {
    ADCP2018$Cell05Vn[i] = "NA"
  }
  if(ADCP2018$Cell05SNR3[i] <= 7) {
    ADCP2018$Cell05Vu[i] = "NA"
  }
  if(ADCP2018$Cell05SNR1[i] <= 7 || ADCP2018$Cell05SNR2[i] <= 7 || ADCP2018$Cell05SNR3[i] <= 7) {
    ADCP2018$Cell05Spd[i] = "NA"
    ADCP2018$Cell05Dir[i] = "NA"
  }
  #Cell06
  if(ADCP2018$Cell06SNR1[i] <= 7) {
    ADCP2018$Cell06Ve[i] = "NA"
  }
  if(ADCP2018$Cell06SNR2[i] <= 7) {
    ADCP2018$Cell06Vn[i] = "NA"
  }
  if(ADCP2018$Cell06SNR3[i] <= 7) {
    ADCP2018$Cell06Vu[i] = "NA"
  }
  if(ADCP2018$Cell06SNR1[i] <= 7 || ADCP2018$Cell06SNR2[i] <= 7 || ADCP2018$Cell06SNR3[i] <= 7) {
    ADCP2018$Cell06Spd[i] = "NA"
    ADCP2018$Cell06Dir[i] = "NA"
  }
  #Cell07
  if(ADCP2018$Cell07SNR1[i] <= 7) {
    ADCP2018$Cell07Ve[i] = "NA"
  }
  if(ADCP2018$Cell07SNR2[i] <= 7) {
    ADCP2018$Cell07Vn[i] = "NA"
  }
  if(ADCP2018$Cell07SNR3[i] <= 7) {
    ADCP2018$Cell07Vu[i] = "NA"
  }
  if(ADCP2018$Cell07SNR1[i] <= 7 || ADCP2018$Cell07SNR2[i] <= 7 || ADCP2018$Cell07SNR3[i] <= 7) {
    ADCP2018$Cell07Spd[i] = "NA"
    ADCP2018$Cell07Dir[i] = "NA"
  }
  #Cell08
  if(ADCP2018$Cell08SNR1[i] <= 7) {
    ADCP2018$Cell08Ve[i] = "NA"
  }
  if(ADCP2018$Cell08SNR2[i] <= 7) {
    ADCP2018$Cell08Vn[i] = "NA"
  }
  if(ADCP2018$Cell08SNR3[i] <= 7) {
    ADCP2018$Cell08Vu[i] = "NA"
  }
  if(ADCP2018$Cell08SNR1[i] <= 7 || ADCP2018$Cell08SNR2[i] <= 7 || ADCP2018$Cell08SNR3[i] <= 7) {
    ADCP2018$Cell08Spd[i] = "NA"
    ADCP2018$Cell08Dir[i] = "NA"
  }
  #Cell09
  if(ADCP2018$Cell09SNR1[i] <= 7) {
    ADCP2018$Cell09Ve[i] = "NA"
  }
  if(ADCP2018$Cell09SNR2[i] <= 7) {
    ADCP2018$Cell09Vn[i] = "NA"
  }
  if(ADCP2018$Cell09SNR3[i] <= 7) {
    ADCP2018$Cell09Vu[i] = "NA"
  }
  if(ADCP2018$Cell09SNR1[i] <= 7 || ADCP2018$Cell09SNR2[i] <= 7 || ADCP2018$Cell09SNR3[i] <= 7) {
    ADCP2018$Cell09Spd[i] = "NA"
    ADCP2018$Cell09Dir[i] = "NA"
  }
  #Cell10
  if(ADCP2018$Cell10SNR1[i] <= 7) {
    ADCP2018$Cell10Ve[i] = "NA"
  }
  if(ADCP2018$Cell10SNR2[i] <= 7) {
    ADCP2018$Cell10Vn[i] = "NA"
  }
  if(ADCP2018$Cell10SNR3[i] <= 7) {
    ADCP2018$Cell10Vu[i] = "NA"
  }
  if(ADCP2018$Cell10SNR1[i] <= 7 || ADCP2018$Cell10SNR2[i] <= 7 || ADCP2018$Cell10SNR3[i] <= 7) {
    ADCP2018$Cell10Spd[i] = "NA"
    ADCP2018$Cell10Dir[i] = "NA"
  }
}
...
for(i in 1:nrow(ADCP2019)) {
  #Overall
  if(ADCP2019$SNR1[i] <= 7) {
    ADCP2019$VelocityE[i] = "NA"
  }
  if(ADCP2019$SNR2[i] <= 7) {
    ADCP2019$VelocityN[i] = "NA"
  }
  if(ADCP2019$SNR3[i] <= 7) {
    ADCP2019$VelocityU[i] = "NA"
  }
  #Overall Speed adjustment
  if(ADCP2019$SNR1[i] <= 7 || ADCP2019$SNR2[i] <= 7 || ADCP2019$SNR3[i] <= 7) {
    ADCP2019$Speed[i] = "NA"
    ADCP2019$Direction[i] = "NA"
  }
  #Cell01
  if(ADCP2019$Cell01SNR1[i] <= 7) {
    ADCP2019$Cell01Ve[i] = "NA"
  }
  if(ADCP2019$Cell01SNR2[i] <= 7) {
    ADCP2019$Cell01Vn[i] = "NA"
  }
  if(ADCP2019$Cell01SNR3[i] <= 7) {
    ADCP2019$Cell01Vu[i] = "NA"
  }
  if(ADCP2019$Cell01SNR1[i] <= 7 || ADCP2019$Cell01SNR2[i] <= 7 || ADCP2019$Cell01SNR3[i] <= 7) {
    ADCP2019$Cell01Spd[i] = "NA"
    ADCP2019$Cell01Dir[i] = "NA"
  }
  #Cell02
  if(ADCP2019$Cell02SNR1[i] <= 7) {
    ADCP2019$Cell02Ve[i] = "NA"
  }
  if(ADCP2019$Cell02SNR2[i] <= 7) {
    ADCP2019$Cell02Vn[i] = "NA"
  }
  if(ADCP2019$Cell02SNR3[i] <= 7) {
    ADCP2019$Cell02Vu[i] = "NA"
  }
  if(ADCP2019$Cell02SNR1[i] <= 7 || ADCP2019$Cell02SNR2[i] <= 7 || ADCP2019$Cell02SNR3[i] <= 7) {
    ADCP2019$Cell02Spd[i] = "NA"
    ADCP2019$Cell02Dir[i] = "NA"
  }
  #Cell03
  if(ADCP2019$Cell03SNR1[i] <= 7) {
    ADCP2019$Cell03Ve[i] = "NA"
  }
  if(ADCP2019$Cell03SNR2[i] <= 7) {
    ADCP2019$Cell03Vn[i] = "NA"
  }
  if(ADCP2019$Cell03SNR3[i] <= 7) {
    ADCP2019$Cell03Vu[i] = "NA"
  }
  if(ADCP2019$Cell03SNR1[i] <= 7 || ADCP2019$Cell03SNR2[i] <= 7 || ADCP2019$Cell03SNR3[i] <= 7) {
    ADCP2019$Cell03Spd[i] = "NA"
    ADCP2019$Cell03Dir[i] = "NA"
  }
  #Cell04
  if(ADCP2019$Cell04SNR1[i] <= 7) {
    ADCP2019$Cell04Ve[i] = "NA"
  }
  if(ADCP2019$Cell04SNR2[i] <= 7) {
    ADCP2019$Cell04Vn[i] = "NA"
  }
  if(ADCP2019$Cell04SNR3[i] <= 7) {
    ADCP2019$Cell04Vu[i] = "NA"
  }
  if(ADCP2019$Cell04SNR1[i] <= 7 || ADCP2019$Cell04SNR2[i] <= 7 || ADCP2019$Cell04SNR3[i] <= 7) {
    ADCP2019$Cell04Spd[i] = "NA"
    ADCP2019$Cell04Dir[i] = "NA"
  }
  #Cell05
  if(ADCP2019$Cell05SNR1[i] <= 7) {
    ADCP2019$Cell05Ve[i] = "NA"
  }
  if(ADCP2019$Cell05SNR2[i] <= 7) {
    ADCP2019$Cell05Vn[i] = "NA"
  }
  if(ADCP2019$Cell05SNR3[i] <= 7) {
    ADCP2019$Cell05Vu[i] = "NA"
  }
  if(ADCP2019$Cell05SNR1[i] <= 7 || ADCP2019$Cell05SNR2[i] <= 7 || ADCP2019$Cell05SNR3[i] <= 7) {
    ADCP2019$Cell05Spd[i] = "NA"
    ADCP2019$Cell05Dir[i] = "NA"
  }
  #Cell06
  if(ADCP2019$Cell06SNR1[i] <= 7) {
    ADCP2019$Cell06Ve[i] = "NA"
  }
  if(ADCP2019$Cell06SNR2[i] <= 7) {
    ADCP2019$Cell06Vn[i] = "NA"
  }
  if(ADCP2019$Cell06SNR3[i] <= 7) {
    ADCP2019$Cell06Vu[i] = "NA"
  }
  if(ADCP2019$Cell06SNR1[i] <= 7 || ADCP2019$Cell06SNR2[i] <= 7 || ADCP2019$Cell06SNR3[i] <= 7) {
    ADCP2019$Cell06Spd[i] = "NA"
    ADCP2019$Cell06Dir[i] = "NA"
  }
  #Cell07
  if(ADCP2019$Cell07SNR1[i] <= 7) {
    ADCP2019$Cell07Ve[i] = "NA"
  }
  if(ADCP2019$Cell07SNR2[i] <= 7) {
    ADCP2019$Cell07Vn[i] = "NA"
  }
  if(ADCP2019$Cell07SNR3[i] <= 7) {
    ADCP2019$Cell07Vu[i] = "NA"
  }
  if(ADCP2019$Cell07SNR1[i] <= 7 || ADCP2019$Cell07SNR2[i] <= 7 || ADCP2019$Cell07SNR3[i] <= 7) {
    ADCP2019$Cell07Spd[i] = "NA"
    ADCP2019$Cell07Dir[i] = "NA"
  }
  #Cell08
  if(ADCP2019$Cell08SNR1[i] <= 7) {
    ADCP2019$Cell08Ve[i] = "NA"
  }
  if(ADCP2019$Cell08SNR2[i] <= 7) {
    ADCP2019$Cell08Vn[i] = "NA"
  }
  if(ADCP2019$Cell08SNR3[i] <= 7) {
    ADCP2019$Cell08Vu[i] = "NA"
  }
  if(ADCP2019$Cell08SNR1[i] <= 7 || ADCP2019$Cell08SNR2[i] <= 7 || ADCP2019$Cell08SNR3[i] <= 7) {
    ADCP2019$Cell08Spd[i] = "NA"
    ADCP2019$Cell08Dir[i] = "NA"
  }
  #Cell09
  if(ADCP2019$Cell09SNR1[i] <= 7) {
    ADCP2019$Cell09Ve[i] = "NA"
  }
  if(ADCP2019$Cell09SNR2[i] <= 7) {
    ADCP2019$Cell09Vn[i] = "NA"
  }
  if(ADCP2019$Cell09SNR3[i] <= 7) {
    ADCP2019$Cell09Vu[i] = "NA"
  }
  if(ADCP2019$Cell09SNR1[i] <= 7 || ADCP2019$Cell09SNR2[i] <= 7 || ADCP2019$Cell09SNR3[i] <= 7) {
    ADCP2019$Cell09Spd[i] = "NA"
    ADCP2019$Cell09Dir[i] = "NA"
  }
  #Cell10
  if(ADCP2019$Cell10SNR1[i] <= 7) {
    ADCP2019$Cell10Ve[i] = "NA"
  }
  if(ADCP2019$Cell10SNR2[i] <= 7) {
    ADCP2019$Cell10Vn[i] = "NA"
  }
  if(ADCP2019$Cell10SNR3[i] <= 7) {
    ADCP2019$Cell10Vu[i] = "NA"
  }
  if(ADCP2019$Cell10SNR1[i] <= 7 || ADCP2019$Cell10SNR2[i] <= 7 || ADCP2019$Cell10SNR3[i] <= 7) {
    ADCP2019$Cell10Spd[i] = "NA"    
    ADCP2019$Cell10Dir[i] = "NA"
    }
}
